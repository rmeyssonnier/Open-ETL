...
export class Engine {
    ...
    public onSnap: (node: HTMLElement, val: boolean, block: Block | undefined) => void;
    ...
    public ItemSelected : EventEmitter<{id: any, type: string, blockRef: HTMLElement}> = new EventEmitter<{id: any; type: string; blockRef: HTMLElement}>();
    ...
    constructor(
        ...
        onRelease?: () => void,
        onSnap?: (node: HTMLElement, val: boolean, block: Block | undefined) => void) {
        this.onGrab = onGrab!;
    ...
    touchblock(event: any) {
        ...
        if (
            ...
            this.ItemSelected.emit({id: draggedElement?.id, type: theblock.querySelector(`.blockelemtype`).value, blockRef: theblock})
